...
🚀 Key Features🛠️
 Admin DashboardUser Management: Secure registration for Drivers and Parents.
 Fleet Management: Add new buses and assign them to specific drivers.
 ...
 🚌 Driver Logic (Simulation)Live GPS Synchronization:Driver location updates to the server every 5 seconds.
